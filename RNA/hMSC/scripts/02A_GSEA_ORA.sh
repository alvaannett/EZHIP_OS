...
Rscript -e "rmarkdown::render(
            ...
            params = list(path_raptor = '/lustre06/project/6004736/alvann/from_narval/220318_EZHIP/RNA/hMSC/out/01_raptor_exprtools/EZHIP/',
                          path_out = '/lustre06/project/6004736/alvann/from_narval/220318_EZHIP/RNA/hMSC/out/02_GSEA_ORA/',
                          prefix = 'hMSC',
                          comp = 'WTvsEZHIP',
                          bm = 100,
                          pval_gene = 0.05, 
                          ...
                          pval_gsea_ora = 1,
                          qval_gsea_ora = 1),
            output_file = '/lustre06/project/6004736/alvann/from_narval/220318_EZHIP/RNA/hMSC/out/02_GSEA_ORA/GSEA_ORA.html')"
