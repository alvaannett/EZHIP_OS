...
tumor_pair.py \
	...
	$MUGQIC_PIPELINES_HOME/pipelines/tumor_pair/tumor_pair.exome.ini \
        files/genpipes_files_batch2/user.config.ini \
     -r files/genpipes_files_batch2/readset.tsv \
     -p files/genpipes_files_batch2/pairs.csv \
     -o out/01_genpipes_tumorpair_batch2 \
